...
CREATE TABLE IF NOT EXISTS `delfinesdb`.`productos` (
  ...
  PRIMARY KEY (`id`, `categorias_id`, `carrito_id`),
  INDEX `fk_productos_categorias1_idx` (`categorias_id` ASC) VISIBLE,
  INDEX `fk_productos_carrito1_idx` (`carrito_id` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `delfinesdb`.`usuarios` (
  ...
  INDEX `fk_usuarios_carrito1_idx` (`carrito_id` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `delfinesdb`.`administradores` (
  ...
  INDEX `fk_administradores_usuarios_idx` (`usuarios_id` ASC) VISIBLE)
ENGINE = InnoDB;
